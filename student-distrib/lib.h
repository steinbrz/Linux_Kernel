...
#define NUM_ROWS 25
#define ATTRIB 0x7
#define KB_ALIGN 0x1000
#define USER_VIDEO 0x09000000
#define VIDEO_DIRECTORY_IDX (USER_VIDEO/ 0x400000)
#define VIDEO1 0x09001000
#define VIDEO1_PHYS 0x00001000
#define VIDEO1_IDX (0x01000 / KB_ALIGN)
#define VIDEO2 0x09003000 
#define VIDEO2_PHYS 0x00003000 
#define VIDEO2_IDX (0x03000/ KB_ALIGN)
#define VIDEO3 0x09005000
#define VIDEO3_PHYS 0x00005000
#define VIDEO3_IDX (0x05000 / KB_ALIGN)
#define SHELL_DOES_EXIST 1
#define SHELL_DOESNT_EXIST 0
